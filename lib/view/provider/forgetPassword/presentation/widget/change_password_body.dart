          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Form(
                  key: ForgetPasswordCubit.of(context).formKeyChangePassword,
                  child: Column(
                    ...
                    children: [
                      ...
                      InputFormField(
                        hint: AppStrings.newChangePasswordBody.translate(),
                        ...
                        secure: true,
                        controller:
                            ForgetPasswordCubit.of(context).passwordController,
                      ),
                      InputFormField(
                        hint: AppStrings.confirmChangePasswordBody.translate(),
                        icon: Icons.lock_outline_sharp,
                        fillColor: Colors.white,
                        textColor: AppColors.fontColor,
                        validator: (value) => Validator.confirmPassword(
                            value,
                            ForgetPasswordCubit.of(context)
                                .passwordController
                                .text),
                        secure: true,
                        controller: ForgetPasswordCubit.of(context)
