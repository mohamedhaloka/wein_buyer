...
class DoneReceivedAmountBottomSheet extends StatefulWidget {
  const DoneReceivedAmountBottomSheet({Key? key}) : super(key: key);

  @override
  State<DoneReceivedAmountBottomSheet> createState() =>
      _DoneReceivedAmountBottomSheetState();
}

class _DoneReceivedAmountBottomSheetState
    extends State<DoneReceivedAmountBottomSheet> {
  @override
  void initState() {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              child: Text(
                AppStrings.doneReceivedAmountBottomSheet.translate(),
