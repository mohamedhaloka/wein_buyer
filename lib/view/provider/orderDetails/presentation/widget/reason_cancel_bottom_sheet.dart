...
class ReasonCancelBottomSheet extends StatelessWidget {
  const ReasonCancelBottomSheet({Key? key, required this.orderId})
      : super(key: key);
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Text(
                AppStrings.reasonCancelBottomSheet.translate(),
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 20.sp,
              ...
              InputFormField(
                hint: AppStrings.writeReasonCancelBottomSheet.translate(),
                multiLine: true,
                maxLines: 3,
                controller:
                    OrderDetailsCubit.of(context).cancelReasonController,
                validator: (String) {},
              ),
              SpaceH(inputHeigth: 10),
              BlocBuilder<OrderDetailsCubit, OrderDetailsState>(
                builder: (context, state) {
                  return state is CancelOrderLoading
                      ...
                      : CustomButton(
                          ...
                          onPress: () {
                            OrderDetailsCubit.of(context).cancelOrder(
                                orderId,
