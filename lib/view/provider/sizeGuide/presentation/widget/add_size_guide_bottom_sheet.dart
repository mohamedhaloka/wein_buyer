...
class AddSizeGuideBottomSheet extends StatefulWidget {
  const AddSizeGuideBottomSheet({Key? key}) : super(key: key);

  @override
  State<AddSizeGuideBottomSheet> createState() =>
      _AddSizeGuideBottomSheetState();
}

class _AddSizeGuideBottomSheetState extends State<AddSizeGuideBottomSheet> {
  @override
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                            ...
                            Text(
                              SizeGuideCubit.of(context).imageSizeGuide != null
                                  ? SizeGuideCubit.of(context)
                                      ...
                                      .split('/')
                                      .last
                                  : AppStrings.namedMapImage.translate(),
                ...
                BlocBuilder<SizeGuideCubit, SizeGuideState>(
                  builder: (context, state) {
                    return state is AddSizeGuideLoading
                        ? const LoadingIndicator()
                        : CustomButton(
                            text: AppStrings.addAddSizeGuideBottomSheet.translate(),
                            radius: 10,
                            onPress: () {
                              SizeGuideCubit.of(context).addSizeGuides();
                            },
                          );
                  },
                ),
