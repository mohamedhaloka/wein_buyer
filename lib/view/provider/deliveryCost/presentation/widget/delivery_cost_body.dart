        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                BlocBuilder<DeliveryCostCubit, DeliveryCostState>(
                  ...
                  builder: (context, state) {
                    return Column(
                      children: [
                        ...
                        SizedBox(
                            height: AppSizes.getProportionateScreenHeight(5)),
                        InputFormField(
                          ...
                          isNumber: true,
                          controller: DeliveryCostCubit.of(context)
                        ...
                        InputFormField(
                          ...
                          clickable: DeliveryCostCubit.of(context).statueUi
                              ? true
                              : false,
                          suffixIcon: Container(
                            width: AppSizes.getProportionateScreenWidth(60),
                            ...
                            if (value.isEmpty) {
                              return AppStrings.emptyField.translate();
                                ...
                                num.parse(DeliveryCostCubit.of(context)
                                    .aroundMeMinController
                                    .text)) {
                              return AppStrings.aroundMeMaxValidation
                                  .translate();
                            }
                          },
                        ),
                        InputFormField(
                          ...
                          validator: Validator.generalField,
                          controller: DeliveryCostCubit.of(context)
                              .aroundMePriceController,
                        ),
                        SizedBox(
                            height: AppSizes.getProportionateScreenHeight(8)),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(
                            ...
                            InfoPopupWidget(
                              contentTitle:
                                  AppStrings.localShipping.translate(),
                              contentTheme: const InfoPopupContentTheme(
                                infoTextStyle:
                                    TextStyle(color: AppColors.primaryColor),
                              ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InfoPopupWidget(
                              contentTitle:
                                  AppStrings.domesticShipping.translate(),
                              contentTheme: const InfoPopupContentTheme(
                                infoTextStyle:
                                    TextStyle(color: AppColors.primaryColor),
                              ),
                            ...
                            if (value.isEmpty) {
                              return AppStrings.emptyField.translate();
                                ...
                                DeliveryCostCubit.of(context)
                                    .localeMaxController
                                    .text) {
                              return AppStrings.domesticMinValidation
                                  .translate();
                            }
                          },
                        ),
                            ...
                            if (value.isEmpty) {
                              return AppStrings.emptyField.translate();
                                ...
                                num.parse(DeliveryCostCubit.of(context)
                                    .domesticMinController
                                    .text)) {
                              return AppStrings.domesticMaxValidation
                                  .translate();
                            }
                          },
                        ),
