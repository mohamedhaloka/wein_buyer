...
class PropertiesEditProduct extends StatelessWidget {
  const PropertiesEditProduct({Key? key}) : super(key: key);
    ...
    return Column(
      children: [
        ...
        BlocBuilder<AddProductCubit, AddProductState>(
          buildWhen: (previous, current) => current is AddAnotherProperty,
          builder: (context, state) {
            List<PropertyModel> listOfProperty =
                AddProductCubit.of(context).listOfProperty;
            return state is AddAnotherProperty
                ? Column(
                          ...
                          children: [
                            Expanded(
                              child: DropdownSearch<String>(
                                ...
                                selectedItem: listOfProperty[index].size,
                                // mode: Mode.MENU,
                                onChanged: (data) {
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                child: Icon(
                                  ...
                                  color: Colors.white,
                                  size:
                                      AppSizes.getProportionateScreenHeight(18),
                                ),
                              ),
                            ),
                          ],
