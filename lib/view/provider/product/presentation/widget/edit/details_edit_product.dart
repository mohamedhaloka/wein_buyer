...
class DetailsEditProduct extends StatelessWidget {
  const DetailsEditProduct({Key? key}) : super(key: key);
            ...
            Expanded(
              child: BlocBuilder<AddProductCubit, AddProductState>(
                buildWhen: (previous, current) =>
                    current is OnSelectMainCateItem,
        ...
        Row(
          children: [
            Expanded(
              child: BlocBuilder<AddProductCubit, AddProductState>(
                buildWhen: (previous, current) =>
                    current is OnSelectSubCateItem,
                builder: (context, state) {
                  final categoryController =
