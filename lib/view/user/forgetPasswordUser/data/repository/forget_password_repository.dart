...
class ForgetPasswordUserRepository extends BaseForgetPasswordUserRepository {
  final BaseForgetPasswordUserRemoteDatasource baseForgetPasswordRemoteDatasource;

  ForgetPasswordUserRepository(this.baseForgetPasswordRemoteDatasource);
