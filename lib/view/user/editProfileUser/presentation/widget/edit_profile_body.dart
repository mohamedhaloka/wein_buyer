      ...
      child: BlocBuilder<EditProfileCubit, EditProfileState>(
        ...
        builder: (context, state) {
          return state is GetProfileLoading
              ? Center(child: Lottie.asset(AppAssets.loadingLottie))
              : Form(
                  ...
                  child: ListView(
                    children: [
                      InkWell(
                        ...
                        child: Center(
                          child: state is SelectedImageProfile
                              ? Container(
                                  width:
                                      AppSizes.getProportionateScreenWidth(100),
                                  height:
                                      AppSizes.getProportionateScreenWidth(100),
                        ...
                        children: [
                          Expanded(
                            ...
                            child: InputFormField(
                              ...
                              controller: EditProfileCubit.of(context)
                                  .firstNameController,
                            ),
                          ),
                      ...
                      InputFormField(
                        ...
                        fillColor: Colors.white,
                        controller:
                            EditProfileCubit.of(context).emailController,
                      ),
                      SpaceH(inputHeigth: 10),
                      InputFormField(
                        ...
                        controller:
                            EditProfileCubit.of(context).phoneController,
                      ),
                      SpaceH(inputHeigth: 10),
                      InkWell(
                        onTap: () {
                      ...
                      InputFormField(
                        ...
                        fillColor: Colors.white,
                        controller:
                            EditProfileCubit.of(context).birthdayController,
                      ),
                      SpaceH(inputHeigth: 10),
                      Container(
                        decoration: BoxDecoration(
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    Radio(
                                      ...
                                      value: Gender.M,
                                      groupValue: EditProfileCubit.of(context)
                                          .genderProfile,
                                      onChanged: (v) {
                                        EditProfileCubit.of(context)
